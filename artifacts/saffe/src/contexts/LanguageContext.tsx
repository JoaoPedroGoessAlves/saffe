...
const ptTranslations: Record<string, string> = {
  ...
  "deepResult.vibePromptLabel": "Prompt de IA (Lovable / Bolt / Cursor)",
  "deepResult.copyPrompt": "Copiar Prompt",
  "deepResult.copied": "Copiado!",
...
const enTranslations: Record<string, string> = {
  ...
  "deepResult.vibePromptLabel": "AI Prompt (Lovable / Bolt / Cursor)",
  "deepResult.copyPrompt": "Copy Prompt",
  "deepResult.copied": "Copied!",
